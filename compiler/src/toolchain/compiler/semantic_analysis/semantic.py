...
from toolchain.compiler.semantic_analysis.symbol_table import Symbol, SymbolTable
from toolchain.compiler.semantic_analysis.types import (
    BOOL,
    FLOAT,
    INT,
    STRING,
...
class SemanticAnalyzer:
    ...
    def _resolve_type(self, type_spec):
        ...
        if type_spec == "def":
            from toolchain.compiler.semantic_analysis.types import ANY
            return ANY
